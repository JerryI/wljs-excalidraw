...
class EWidget extends WidgetType {
  ...
  toDOM(view) {
    ...
    const mount = async (element, data) => { 
      if (!loaded) {
        React = (await import('./index-503583a0.js').then(function (n) { return n.i; })).default;
        ReactDOM = (await import('./index-e88b12a7.js').then(function (n) { return n.i; })).default;
        ExcalidrawLib = (await import('./main-0070dc82.js').then(function (n) { return n.m; })).default;
        loaded = true;
      }
